...
CREATE TABLE IF NOT EXISTS `t_sysdict_form_editor_xtype` (
  `id` varchar(255) NOT NULL,
  `code` varchar(255) NOT NULL,
  `code_int` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_raw_material` (
  `id` varchar(255) NOT NULL,
  `category_id` varchar(255) NOT NULL,
  `code` varchar(255) NOT NULL,
  `name` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_raw_material_category` (
  `id` varchar(255) NOT NULL,
  `code` varchar(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  `parent_id` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_material_unit` (
  `id` varchar(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  `data_org` varchar(255) DEFAULT NULL,
  `company_id` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_sysdict_tax_rate` (
  `id` varchar(255) NOT NULL,
  `code` varchar(255) NOT NULL,
  `code_int` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
DROP TABLE IF EXISTS `t_sysdict_gender`;
CREATE TABLE IF NOT EXISTS `t_sysdict_gender` (
  `id` varchar(255) NOT NULL,
  `code` varchar(255) NOT NULL,
  `code_int` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
